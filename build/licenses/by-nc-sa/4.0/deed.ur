...
xmlns:frbr="http://purl.org/vocab/frbr/core#" xml:lang="ur">
...
<head about="http://creativecommons.org/licenses/by-nc-sa/4.0/">
  ...
  Creative Commons &mdash; Attribution-NonCommercial-ShareAlike 4.0 International
...
<body typeof="cc:License" about="http://creativecommons.org/licenses/by-nc-sa/4.0/" class="license rtl">
...
<div id="language-selector-block" class="container">
    ...
    <select>
        ...
        <div id="primary" class="content-area">
          <main id="main" class="site-main container" role="main">
            <div id="deed" class="row" dir="rtl" style="text-align: right">
  ...
  <span class="cc-license-title" property="dc:title dct:title">Attribution-NonCommercial-ShareAlike 4.0 International</span>
  <span class="cc-license-identifier" property="dc:identifier dct:identifier">
    (CC BY-NC-SA 4.0)
              ...
              <div id="deed-main" dir="rtl" style="text-align: right" class="row">
                <div id="legalcode-block">
                  <div id="deed-disclaimer">
                    ...
                    <span class="disclaimer">
                      <a href="#" id="disclaimer_popup" class="helpLink">Disclaimer</a>.
                    </span>
                  </div>
                </div>
  ...
  <div id="deed-rights"
       dir="rtl" style="text-align: right" class="row">
  ...
  <div id="deed-conditions" class="row">
    ...
    <ul dir="rtl" style="text-align: right" class="license-properties col-md-offset-2 col-md-8">

      <li class="license by">
          <p>
            <strong>Attribution</strong> &mdash; <span rel="cc:requires"
      ...
      <li class="license nc"
          ...
          <p>
            <strong>NonCommercial</strong> &mdash; You may not use the material for <a href="#" id="commercial_purposes_popup" class="helpLink">commercial purposes</a>.
      ...
      <li class="license sa"
          ...
          <p>
            <strong>ShareAlike</strong> &mdash; If you remix, transform, or build upon the material, you must distribute your contributions under the <a href="#" id="same_license_popup" class="helpLink">same license</a> as the original.
  ...
  <span id="referrer-metadata-container" />
        ...
        <a href="http://wiki.creativecommons.org/FAQ">Learn more</a> about CC licensing, or <a id="get_this" href="/choose/results-one?license_code=by-nc-sa&amp;amp;jurisdiction=&amp;amp;version=4.0&amp;amp;lang=ur">use the license</a> for your own material.
...
<div class="site-footer-wrapper">
  ...
  <div id="help_attribution_help" class="help_panel">
    ...
    <div class="bd">
      <p>The page you came from contained embedded licensing metadata, including how the creator wishes to be attributed for re-use. You can use the HTML here to cite the work. Doing so will also include metadata on your page so that others can find the original work as well.</p>
    </div>
  </div>
