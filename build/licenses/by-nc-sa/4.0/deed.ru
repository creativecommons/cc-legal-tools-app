...
<head about="http://creativecommons.org/licenses/by-nc-sa/4.0/">
  ...
  Creative Commons &mdash; «Attribution-NonCommercial-ShareAlike» («Атрибуция — Некоммерческое использование — На тех же условиях») 4.0 Весь мир (в т.ч. Россия и др.)
...
<div id="language-selector-block" class="container">
  ...
  <span class="cc-license-title" property="dc:title dct:title">«Attribution-NonCommercial-ShareAlike» («Атрибуция — Некоммерческое использование — На тех же условиях») 4.0 Весь мир (в т.ч. Россия и др.)</span>
  ...
  <span id="referrer-metadata-container" />
        ...
        <a href="http://wiki.creativecommons.org/FAQ">Узнайте больше</a> о лицензиях CC или <a id="get_this" href="/choose/results-one?license_code=by-nc-sa&amp;amp;jurisdiction=&amp;amp;version=4.0&amp;amp;lang=ru">используйте эту лицензию</a> для своих собственных произведений.
