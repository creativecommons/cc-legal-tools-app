...
xmlns:frbr="http://purl.org/vocab/frbr/core#" xml:lang="sl">
...
<head about="http://creativecommons.org/licenses/by-nc-sa/4.0/">
  ...
  Creative Commons &mdash; Priznanje avtorstva-Nekomercialno-Deljenje pod enakimi pogoji 4.0 International
...
<div class="site-header-wrapper">
  <header id="masthead" class="site-header sticky-nav-main" role="banner">
    <div class="site-header-main">
      ...
      <button id="menu-toggle" class="menu-toggle"><i class="cc-icon-menu"></i> <span>Meni</span></button>

      <div id="site-header-menu" class="site-header-menu">
        <nav id="mobile-navigation" class="mobile-navigation" role="navigation" aria-label="Mobile Menu">
          <div class="menu-mobile-menu-container"><ul id="menu-mobile-menu" class="mobile-menu">
            <li id="menu-item-48798" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-48798"><a href="https://creativecommons.org/share-your-work/">Delite svoje delo</a></li>
            <li id="menu-item-48799" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-48799"><a href="https://creativecommons.org/use-remix/">Uporaba &#038; predelava (remix)</a></li>
            ...
            <li id="menu-item-48803" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-48803"><a href="https://creativecommons.org/use-remix/search-the-commons/">Išči po ustvarjalni gmajni</a></li>
          </ul></div>
        </nav><!-- .main-navigation -->

        <nav id="site-navigation" class="main-navigation" role="navigation" aria-label="Primary Menu">
          <div class="menu-primary-menu-container"><ul id="menu-primary-menu" class="primary-menu">
            <li id="menu-item-48791" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-48791"><a href="https://creativecommons.org/share-your-work/">Delite svoje delo</a></li>
            <li id="menu-item-48792" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-48792"><a href="https://creativecommons.org/use-remix/">Uporaba &#038; predelava (remix)</a></li>
        ...
        <nav id="social-navigation" class="social-navigation" role="navigation" aria-label="Social Links Menu">
          <div class="menu-social-links-container"><ul id="menu-social-links" class="social-links-menu">
            ...
            <li id="menu-item-48809" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-48809"><a href="mailto:info@creativecommons.org"><span class="screen-reader-text">Pošta</span></a></li>
          </ul></div>
        </nav>
            ...
            <div class="textwidget">
              <div id="donation-bar-wrapper" class="donation-bar-wrapper">
                <div id="donation-bar-inner" class="donation-bar-inner">
                  <p class="donate-text">Pomagajte nam vzpostaviti živahno skupnost globalne gmajne</p>
                  <div class="donate-action"><a href="https://us.netdonor.net/page/6650/donate/1?ea.tracking.id=deed-top" class="button donate arrow">Donirajte<span class="hide-on-mobile"> Zdaj</span></a></div>
                </div>
              </div>
            </div>
          </section>
...
<div id="language-selector-block" class="container">
          ...
          <main id="main" class="site-main container" role="main">
            <div id="deed" class="row" dir="ltr" style="text-align: left">
              <div id="deed-head" class="row">
                ...
                <h1><span>Povzetek Creative Commons license (License Deed)</span></h1>
  ...
  <span class="cc-license-title" property="dc:title dct:title">Priznanje avtorstva-Nekomercialno-Deljenje pod enakimi pogoji 4.0 International</span>
  ...
  <div id="deed-rights"
    ...
    <div class="col-sm-offset-2 col-sm-8">
      <h3 style="text-align: center" resource="http://creativecommons.org/ns#Reproduction"
          rel="cc:permits">Dovoljeno vam je:</h3>
      <ul class="license-properties">
        ...
        <strong>Deljenje</strong> &mdash; kopiranje in razširjanje vsebin v kakršnemkoli mediju in obliki
          ...
          <li class="license remix"
            ...
            <strong>Predelovanje</strong> &mdash; remixanje, urejanje, predelava in vključevanje vsebine v lastna dela
          </li>
  ...
  <div class="row">
    <ul id="license-freedoms-no-icons" style="text-align: center" class="col-sm-offset-2 col-sm-8">
      <li class="license">Dajalec licence vam ne more odreči teh pravic, dokler upoštevate pogoje licence.</li>
    </ul>
  </div>
  ...
  <div id="deed-conditions" class="row">
    ...
    <ul dir="ltr" style="text-align: left" class="license-properties col-md-offset-2 col-md-8">
      ...
      <li class="license by">
          ...
          resource="http://creativecommons.org/ns#Attribution"><a href="#" id="appropriate_credit_popup" class="helpLink">Primerno morate navesti avtorja</a></span>, povezavo do licence in <span rel="cc:requires" resource="http://creativecommons.org/ns#Notice"><a href="#" id="indicate_changes_popup" class="helpLink">označiti spremembe, če so kakšne nastale</a></span>. To lahko storite na kakršenkoli razumen način, vendar ne na način, ki bi namigoval na to, da dajalec licence podpira vas ali vašo uporabo dela.
            <span id="by-more-container"></span>
          </p>

          <p id="work-attribution-container" style="display:none;">
            <strong>
              Navedite avtorstvo tega dela:
            </strong>
            <br/>
      ...
      <li class="license nc"
          ...
          <p>
            <strong>Nekomercialno</strong> &mdash; Te vsebine ne smete uporabiti v <a href="#" id="commercial_purposes_popup" class="helpLink">komercialne namene</a>.
      ...
      <li class="license sa"
          ...
          <p>
            <strong>Deljenje pod enakimi pogoji</strong> &mdash; Če vsebino uredite, predelate (remixate) ali gradite na njej, morate svojo različico razširjati pod <a href="#" id="same_license_popup" class="helpLink">isto licenco</a> kot izvirnik.
  ...
  <div class="row">
    <ul id="deed-conditions-no-icons" class="col-md-offset-2 col-md-8">
      <li class="license">
        <strong>Brez dodatnih omejitev</strong> &mdash; Ne smete uporabiti pravnih določil ali <a href="#" id="technological_measures_popup" class="helpLink">tehničnih ukrepov</a>, ki bi pravno omejili ali onemogočilo druge, da bi storili karkoli, kar licenca dovoli.
      </li>
    </ul>
  </div>
  <div class="row"><div class="col-md-offset-1 col-md-10"><hr /></div></div>
  <div id="deed-understanding" class="row">
    ...
    <ul class="understanding license-properties col-md-offset-2 col-md-8">
      ...
      <li class="license">
        Podana niso nobene jamstva. Možno je, da vam licenca ne daje vseh pravic za vam želeno uporabo. Na primer, druge pravice, kot <a href="#" id="publicity_privacy_or_moral_rights_popup" class="helpLink">osebnostne pravice, pravice zasebnosti in moralne pravice</a>, lahko omejujejo kako smete uporabiti vsebino.
      </li>
    </ul>
  ...
  <span id="referrer-metadata-container" />
        ...
        <a href="http://wiki.creativecommons.org/FAQ">Preberite več</a> o licenciranju CC ali <a id="get_this" href="/choose/results-one?license_code=by-nc-sa&amp;amp;jurisdiction=&amp;amp;version=4.0&amp;amp;lang=sl">uporabite to licenco</a> za vašo lastno vsebino.
                  ...
                  <div id="deed-donate-footer">
                    <div class="footer-trigger">
                      ...
                      <div class="footer-trigger-content">
                        <p>Ta vsebina je prosto na voljo pod enostavnimi pravnimi pogoji zaradi Creative Commons, ki je neprofitna organizacija, ki uspe preživeti zaradi donacij. Če vam je ta vsebina všeč, in vam je všeč, da je prosto na voljo vsem, razmislite o donaciji, ki bi podprla naše delo.</p>
...
<div id="deed-donate-slide" style="display: none;">
  <div class="slide-trigger">
    ...
    <p class="desktop-only">Ta vsebina je prosto na voljo pod enostavnimi pravnimi pogoji zaradi Creative Commons, ki je neprofitna organizacija, ki uspe preživeti zaradi donacij. Če vam je ta vsebina všeč, in vam je všeč, da je prosto na voljo vsem, razmislite o donaciji, ki bi podprla naše delo.</p>
    <p class="mobile-only">Ko delite, vsi pridobijo.</p>
        ...
        <div class="gform_wrapper" id="gform_wrapper_10">
          <form method="get" id="gform_10" action="https://us.netdonor.net/page/6650/donate/1" class="deed-donate-form">
            <div id="field_10_1" class="gfield field_sublabel_below field_description_below">
              <label class="gfield_label">Prispevajte danes k Creative Commons</label>
              <div class="ginput_container ginput_container_radio">
                <ul class="gfield_radio" id="input_10_1">
                  ...
                  <li class="gchoice_10_1_4">
                    ...
                    <input name="transaction.donationAmt.other" type="text" id="input_10_1_other" tabindex="5" style="max-width: 80%" placeholder="Znesek" aria-label="Znesek">
                  </li>
                </ul>
                ...
                <input type="submit" id="gform_submit_button_10" class="gform_button button" value="Darujte danes" tabindex="6">
              </div>
            </div>
          </form>
        </div>
...
<div class="site-footer-wrapper">
  <footer id="colophon" class="site-footer sticky-nav-main" role="contentinfo">
    <div class="cc-footer">
        ...
        <div class="cc-footer-links">
          <div class="menu-footer-links-container">
            <ul id="menu-footer-links" class="menu">
              ...
              <li id="menu-item-48795" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-48795"><a href="https://creativecommons.org/privacy/">Zasebnost</a></li>
              <li id="menu-item-48796" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-48796"><a href="https://creativecommons.org/policies/">Pravilniki</a></li>
              <li id="menu-item-48797" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-48797"><a href="https://creativecommons.org/terms/">Pogoji</a></li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="column cc-footer-contact">
        <h6><a href="https://creativecommons.org/about/contact">Zelo radi bi slišali od vas!</a></h6>
        ...
        <ul>
          ...
          <li><a href="https://creativecommons.org/faq">Pogosto zastavljena vprašanja</a></li>
        </ul>
      </div>
  ...
  <div id="help_attribution_help" class="help_panel">
    <div class="hd">
      Kaj pomeni »Določi avtorja tega dela«?
    </div>
    <div class="bd">
      <p>Stran, s katere ste bili preusmerjeni, ima vdelane licenčne metapodatke, vključno s podatki o tem, kako želi biti avtor naveden za ponovno uporabo. Uporabite lahko HTML tukaj za citiranje dela. S tem boste tudi vključili metapodatke na vašo stran, tako da bodo ostali našli tudi izvirno delo.</p>
    </div>
  </div>

  <div id="help_mediation_and_arbitration_popup" class="help_panel">
    <div class="bd">
      <p>Ustrezna pravila mediacije bodo označena v obvestilu o avtorskih pravicah, priloženo skupaj z delom; oziroma če teh ni, v pozivu k mediaciji. Če ni določeno drugače v obvestilu o avtorskih pravicah, priloženem temu delu, se za arbitražo uporablja Arbitražna pravila UNCITRAL (UNCITRAL Arbitration Rules).</p>
  ...
  <div id="help_appropriate_credit_popup" class="help_panel">
    <div class="bd">
      <p>V kolikor so bili priloženi, morate navesti ime avtorja in drugih oseb, ki jih je treba navesti, obvestilo o avtorskih pravicah, obvestilo o licenci, obvestilo o ne-jamstvu in povezavo do vsebine. CC licence starejše od Različice 4.0 zahtevajo tudi, da navedete naslov vsebine, če je bil ta priložen, in se lahko tudi drugače razlikujejo v podrobnostih.</p>
  ...
  <div id="help_indicate_changes_popup" class="help_panel">
    <div class="bd">
      <p>V različici 4.0, če ste vsebino spremenili, morate to označiti ter obdržati vse označbe prejšnjih sprememb. V različici 3.0 in starejših, je označba sprememb bila potrebna samo v primeru, da ste iz dela ustvarili predelavo.</p>
  ...
  <div id="help_same_license_popup" class="help_panel">
    <div class="bd">
      <p>Lahko uporabite tudi eno izmed licenc, ki so označene kot kompatibilne na <a href="https://creativecommons.org/compatiblelicenses">https://creativecommons.org/compatiblelicenses</a></p>
  ...
  <div id="help_commercial_purposes_popup" class="help_panel">
    <div class="bd">
      <p>Komercialna uporaba je uporaba, ki je primarno namenjena komercialni izrabi ali denarnemu nadomestilu.</p>
  ...
  <div id="help_some_kinds_of_mods_popup" class="help_panel">
    <div class="bd">
      <p>Zgolj sprememba oblike ali vrste datoteke nikoli ne šteje kot predevala dela.</p>
  ...
  <div id="help_technological_measures_popup" class="help_panel">
    <div class="bd">
      <p>Licenca prepoveduje uporabo efektivnih tehničnih ukrepov, kot so definirani v 11. členu WIPO Copyright Treaty.</p>
  ...
  <div id="help_exception_or_limitation_popup" class="help_panel">
    <div class="bd">
      <p>CC licence ne vplivajo na pravice uporabnikov na podlagi zakonskih izjem in omejitev.</p>
  ...
  <div id="help_publicity_privacy_or_moral_rights_popup" class="help_panel">
    <div class="bd">
      <p>Možno je, da si morate pridobiti dodatna dovoljenja pred lahko uporabite vsebino na želen način.</p>
  ...
  /* <![CDATA[ */
  var screenReaderText = {"expand":"razširi podrejeni meni","collapse":"strni podrejeni meni"};
  /* ]]> */
