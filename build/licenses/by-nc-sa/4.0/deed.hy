...
xmlns:frbr="http://purl.org/vocab/frbr/core#" xml:lang="hy">
...
<head about="http://creativecommons.org/licenses/by-nc-sa/4.0/">
  ...
  Creative Commons &mdash; Հղում - ոչ-առևտրային օգտագործում - համանման տարածում 4.0 International
...
<div id="language-selector-block" class="container">
  <div class="language-selector-inner">
    <span dir="ltr" style="text-align: left">
      Այս կայք էջը հասանելի է նաև հետևյալ լեզուներով՝
    </span>
  ...
  <span class="cc-license-title" property="dc:title dct:title">Հղում - ոչ-առևտրային օգտագործում - համանման տարածում 4.0 International</span>
                ...
                <div id="legalcode-block">
                  <div id="deed-disclaimer">
                    ...
                    <span class="disclaimer">
                      <a href="#" id="disclaimer_popup" class="helpLink">Պատասխանատվության սահմանափակումներ</a>.
                    </span>
                  </div>
                </div>
  ...
  <div id="deed-conditions" class="row">
    ...
    <ul dir="ltr" style="text-align: left" class="license-properties col-md-offset-2 col-md-8">
      ...
      <li class="license nc"
          ...
          <p>
            <strong>Ոչ-առևտրային օգտագործում</strong> &mdash; You may not use the material for <a href="#" id="commercial_purposes_popup" class="helpLink">commercial purposes</a>.
      ...
      <li class="license sa"
          ...
          <p>
            <strong>Համանման տարածում</strong> &mdash; If you remix, transform, or build upon the material, you must distribute your contributions under the <a href="#" id="same_license_popup" class="helpLink">same license</a> as the original.
  ...
  <div class="row">
    <ul id="deed-conditions-no-icons" class="col-md-offset-2 col-md-8">
      <li class="license">
        <strong>No additional restrictions</strong> &mdash; You may not apply legal terms or <a href="#" id="technological_measures_popup" class="helpLink">technological measures</a> that legally restrict others from doing anything the license permits.
      </li>
    </ul>
  </div>
  <div class="row"><div class="col-md-offset-1 col-md-10"><hr /></div></div>
  <div id="deed-understanding" class="row">
    ...
    <ul class="understanding license-properties col-md-offset-2 col-md-8">
      ...
      <li class="license">
        You do not have to comply with the license for elements of the material in the public domain or where your use is permitted by an applicable <a href="#" id="exception_or_limitation_popup" class="helpLink">exception or limitation</a>.
      </li>
      <li class="license">
        No warranties are given. The license may not give you all of the permissions necessary for your intended use. For example, other rights such as <a href="#" id="publicity_privacy_or_moral_rights_popup" class="helpLink">publicity, privacy, or moral rights</a> may limit how you use the material.
      </li>
    </ul>
  ...
  <span id="referrer-metadata-container" />
        ...
        <a href="http://wiki.creativecommons.org/FAQ">Learn more</a> about CC licensing, or <a id="get_this" href="/choose/results-one?license_code=by-nc-sa&amp;amp;jurisdiction=&amp;amp;version=4.0&amp;amp;lang=hy">use the license</a> for your own material.
...
<div class="site-footer-wrapper">
    ...
    <div class="cc-footer">
      ...
      <div class="column cc-footer-contact">
        ...
        <ul>
          ...
          <li><a href="https://creativecommons.org/faq">Հաճախակի տրվող հարցեր</a></li>
        </ul>
      </div>
  ...
  <div id="help-panels" style="display: none">
      ...
      <div id="help_disclaimer_popup" class="help_panel">
        <div class="hd">Պատասխանատվության սահմանափակումներ</div>
  ...
  <div id="help_attribution_help" class="help_panel">
    <div class="hd">
      Ի՞նչ է նշանակում «Սույն Ստեղծագործության հղում» ձևակերպումը
    </div>
    <div class="bd">
      <p>Նախորդ կայք էջը պարունակում է լիցենզիային առնչվող մետատվյալներ, այդ թվում՝ տեղեկություն, թե ինչպես է ստեղծագործողը ցանկանում, որ իրեն հղում կատարեն վերաօգտագործման դեպքում։ Դուք կարող եք օգտագործել  HTML-ը ստեղծագործությանը հղում կատարելու համար։ Դրանով Դուք ներառում եք մետատվյալները Ձեր կայք էջում այնպես, որ մյուսները հնարավորություն ունենան գտնելու նաև ստեղծագործության բնօրինակը։</p>
    </div>
  </div>
