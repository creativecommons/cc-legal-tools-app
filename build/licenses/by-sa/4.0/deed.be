        ...
        <div id="libre" class="col-sm-2">
          <a href="http://freedomdefined.org/" class="screen-only">
            <img src="/static/images/deed/FreeCulturalWorks_seal_x2.jpg" style="border: 0"
                 alt="Гэта ліцэнзія прымальная для твораў Свабоднай культуры." />
          </a>
...
<a href="http://wiki.creativecommons.org/FAQ">Чытайце больш падрабязна</a> пра ліцэнзаванне CC ці <a id="get_this" href="/choose/results-one?license_code=by-sa&amp;amp;jurisdiction=&amp;amp;version=4.0&amp;amp;lang=be">выкарыстоўвайце ліцэнзію</a> для вашых асабістых матэрыялаў.
