...
<head about="http://creativecommons.org/licenses/by-nd/4.0/">
  ...
  Creative Commons &mdash; Attribution-NoDerivatives 4.0 അന്തർദേശീയം
  &mdash; CC BY-ND 4.0
...
<div id="language-selector-block" class="container">
  ...
  <span class="cc-license-title" property="dc:title dct:title">Attribution-NoDerivatives 4.0 അന്തർദേശീയം</span>
  ...
  <span id="referrer-metadata-container" />
        ...
        <a href="http://wiki.creativecommons.org/FAQ">Learn more</a> about CC licensing, or <a id="get_this" href="/choose/results-one?license_code=by-nd&amp;amp;jurisdiction=&amp;amp;version=4.0&amp;amp;lang=ml">use the license</a> for your own material.
