...
<head about="http://creativecommons.org/licenses/by-nc-nd/4.0/">
  ...
  Creative Commons &mdash; Հղում - Ոչ-առևտրային օգտագործում - Օգտագործում առանց վերափոխումների 4.0 International
...
<div id="language-selector-block" class="container">
  ...
  <span class="cc-license-title" property="dc:title dct:title">Հղում - Ոչ-առևտրային օգտագործում - Օգտագործում առանց վերափոխումների 4.0 International</span>
  ...
  <div id="deed-conditions" class="row">
    ...
    <ul dir="ltr" style="text-align: left" class="license-properties col-md-offset-2 col-md-8">
      ...
      <li class="license nd">
          <p>
            <strong>NoDerivatives</strong> &mdash; If you <a href="#" id="some_kinds_of_mods_popup" class="helpLink">remix, transform, or build upon</a> the material, you may not distribute the modified material.
  ...
  <span id="referrer-metadata-container" />
        ...
        <a href="http://wiki.creativecommons.org/FAQ">Learn more</a> about CC licensing, or <a id="get_this" href="/choose/results-one?license_code=by-nc-nd&amp;amp;jurisdiction=&amp;amp;version=4.0&amp;amp;lang=hy">use the license</a> for your own material.
