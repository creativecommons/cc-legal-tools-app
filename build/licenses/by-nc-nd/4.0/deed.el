...
xmlns:frbr="http://purl.org/vocab/frbr/core#" xml:lang="el">
...
<head about="http://creativecommons.org/licenses/by-nc-nd/4.0/">
  ...
  Creative Commons &mdash; Αναφορά Δημιουργού-Μη Εμπορική Χρήση-Όχι Παράγωγα Έργα 4.0 Διεθνές
...
<div id="language-selector-block" class="container">
  ...
  <span class="cc-license-title" property="dc:title dct:title">Αναφορά Δημιουργού-Μη Εμπορική Χρήση-Όχι Παράγωγα Έργα 4.0 Διεθνές</span>
  ...
  <div id="deed-conditions" class="row">
    ...
    <ul dir="ltr" style="text-align: left" class="license-properties col-md-offset-2 col-md-8">
      ...
      <li class="license nc"
          ...
          <p>
            <strong>Μη Εμπορική Χρήση</strong> &mdash; Δε μπορείτε να χρησιμοποιήσετε το υλικό για <a href="#" id="commercial_purposes_popup" class="helpLink">εμπορικούς σκοπούς</a>.
      ...
      <li class="license nd">
          <p>
            <strong>Μη παραγόμενα </strong> &mdash; Αν <a href="#" id="some_kinds_of_mods_popup" class="helpLink">αναμείξετε, τροποποιήσετε, ή δημιουργήσετε πάνω</a> στο υλικό, δε μπορείτε να διανείμετε το τροποποιημένο υλικό.
...
<a href="http://wiki.creativecommons.org/FAQ">Μάθετε περισσότερα</a> σχετικά με την CC αδειοδότηση ή <a id="get_this" href="/choose/results-one?license_code=by-nc-nd&amp;amp;jurisdiction=&amp;amp;version=4.0&amp;amp;lang=el">χρησιμοποιήστε την άδεια</a> σε δικό σας υλικό.
