...
xmlns:frbr="http://purl.org/vocab/frbr/core#" xml:lang="pl">
...
<head about="http://creativecommons.org/licenses/by-nc-nd/4.0/">
  ...
  Creative Commons &mdash; Uznanie autorstwa-Użycie niekomercyjne-Bez utworów zależnych 4.0 Międzynarodowe
...
<div id="language-selector-block" class="container">
  ...
  <span class="cc-license-title" property="dc:title dct:title">Uznanie autorstwa-Użycie niekomercyjne-Bez utworów zależnych 4.0 Międzynarodowe</span>
  ...
  <div id="deed-conditions" class="row">
    ...
    <ul dir="ltr" style="text-align: left" class="license-properties col-md-offset-2 col-md-8">
      ...
      <li class="license nc"
          ...
          <p>
            <strong>Użycie niekomercyjne</strong> &mdash; Nie należy wykorzystywać utworu do <a href="#" id="commercial_purposes_popup" class="helpLink">celów komercyjnych</a>
      ...
      <li class="license nd">
          <p>
            <strong>Bez utworów zależnych</strong> &mdash; <a href="#" id="some_kinds_of_mods_popup" class="helpLink">Remiksując, przetwarzając lub tworząc na podstawie</a> utworu, nie wolno rozpowszechniać zmodyfikowanych treści.
...
Dowiedz się więcej na temat <a href="http://wiki.creativecommons.org/FAQ">licencji Creative Commons</a> albo <a id="get_this" href="/choose/results-one?license_code=by-nc-nd&amp;amp;jurisdiction=&amp;amp;version=4.0&amp;amp;lang=pl">użyj tej licencji</a> dla udostępnienia własnych treści.
