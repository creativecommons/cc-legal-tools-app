...
xmlns:frbr="http://purl.org/vocab/frbr/core#" xml:lang="ru">
...
<head about="http://creativecommons.org/licenses/by-nc-nd/4.0/">
  ...
  Creative Commons &mdash; «Attribution-NonCommercial-NoDerivatives» («Атрибуция — Некоммерческое использование — Без производных произведений») 4.0 Весь мир (в т.ч. Россия и др.)
...
<div id="language-selector-block" class="container">
  ...
  <span class="cc-license-title" property="dc:title dct:title">«Attribution-NonCommercial-NoDerivatives» («Атрибуция — Некоммерческое использование — Без производных произведений») 4.0 Весь мир (в т.ч. Россия и др.)</span>
  ...
  <div id="deed-rights"
    ...
    <div class="col-sm-offset-2 col-sm-8">
      <h3 style="text-align: center" resource="http://creativecommons.org/ns#Reproduction"
          rel="cc:permits">Вы можете свободно:</h3>
  ...
  <div class="row">
    <ul id="license-freedoms-no-icons" style="text-align: center" class="col-sm-offset-2 col-sm-8">
      <li class="license">Лицензиар не вправе отозвать эти разрешения, пока вы выполняете условия лицензии.</li>
    </ul>
  </div>
  ...
  <div id="deed-conditions" class="row">
    ...
    <ul dir="ltr" style="text-align: left" class="license-properties col-md-offset-2 col-md-8">
      ...
      <li class="license nc"
          ...
          <p>
            <strong>«NonCommercial» («Некоммерчески»)</strong> &mdash; Вы не вправе использовать этот материал в <a href="#" id="commercial_purposes_popup" class="helpLink">коммерческих целях</a>.
      ...
      <li class="license nd">
          <p>
            <strong>«NoDerivatives» («Без производных произведений»)</strong> &mdash; Если вы <a href="#" id="some_kinds_of_mods_popup" class="helpLink">перерабатываете, преобразовываете материал или берёте его за основу для производного произведения</a>, вы не можете распространять измененный материал.
  ...
  <span id="referrer-metadata-container" />
        ...
        <a href="http://wiki.creativecommons.org/FAQ">Узнайте больше</a> о лицензиях CC или <a id="get_this" href="/choose/results-one?license_code=by-nc-nd&amp;amp;jurisdiction=&amp;amp;version=4.0&amp;amp;lang=ru">используйте эту лицензию</a> для своих собственных произведений.
                  ...
                  <div id="deed-donate-footer">
                    <div class="footer-trigger">
                      ...
                      <div class="footer-trigger-content">
                        <p>Вы перешли по ссылке, чтобы узнать лицензию произведения? Оно стало доступным для бесплатного использования на простых юридических условиях благодаря работе некоммерческой организации Creative Commons. Пожалуйста, поддержите нас пожертвованием, если вам нравится этот контент и его доступность самой широкой аудитории.</p>
...
<div id="deed-donate-slide" style="display: none;">
  <div class="slide-trigger">
    ...
    <p class="desktop-only">Вы перешли по ссылке, чтобы узнать лицензию произведения? Оно стало доступным для бесплатного использования на простых юридических условиях благодаря работе некоммерческой организации Creative Commons. Пожалуйста, поддержите нас пожертвованием, если вам нравится этот контент и его доступность самой широкой аудитории.</p>
          ...
          <form method="get" id="gform_10" action="https://us.netdonor.net/page/6650/donate/1" class="deed-donate-form">
            <div id="field_10_1" class="gfield field_sublabel_below field_description_below">
              ...
              <div class="ginput_container ginput_container_radio">
                ...
                <input type="submit" id="gform_submit_button_10" class="gform_button button" value="Пожертвовать" tabindex="6">
              </div>
            </div>
          </form>
        </div>
    ...
    <div class="cc-footer">
      ...
      <div class="column cc-footer-contact">
        ...
        <ul>
          ...
          <li><a href="https://creativecommons.org/faq"><a href="https://wiki.creativecommons.org/wiki/Ru:FFAQ">Часто задаваемые вопросы (по-русски)</a></a></li>
        </ul>
      </div>
  ...
  <div id="help_indicate_changes_popup" class="help_panel">
    <div class="bd">
      ...
      <p><a href="http://wiki.creativecommons.org/Best_practices_for_attribution#This_is_a_good_attribution_for_material_you_modified_slightly">
        Руководство по маркировке контента</a>.</p>
