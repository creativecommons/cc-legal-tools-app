...
xmlns:frbr="http://purl.org/vocab/frbr/core#" xml:lang="be">
  ...
  <div id="deed-conditions" class="row">
    ...
    <ul dir="ltr" style="text-align: left" class="license-properties col-md-offset-2 col-md-8">
      ...
      <li class="license nc"
          ...
          <p>
            <strong>Некамерцыйнае выкарыстанне</strong> &mdash; Вы не можаце выкарыстоўваць гэты матэрыял для <a href="#" id="commercial_purposes_popup" class="helpLink">камерцыйных мэтаў</a>.
      ...
      <li class="license nd">
          <p>
            <strong>Без залежных твораў</strong> &mdash; Калі вы <a href="#" id="some_kinds_of_mods_popup" class="helpLink">рэміксуеце, змяняеце, або ствараеце залежны</a> твор, вы можаце не распаўсюджваць зменены матэрыял.
...
<a href="http://wiki.creativecommons.org/FAQ">Чытайце больш падрабязна</a> пра ліцэнзаванне CC ці <a id="get_this" href="/choose/results-one?license_code=by-nc-nd&amp;amp;jurisdiction=&amp;amp;version=4.0&amp;amp;lang=be">выкарыстоўвайце ліцэнзію</a> для вашых асабістых матэрыялаў.
