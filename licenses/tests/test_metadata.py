...
#         self.assertEqual(
#             "http://creativecommons.org/license/software", license.license_class_url
#         )
#
...
#         self.assertEqual(
#             legalcode.url, "http://creativecommons.org/licenses/by-nc-nd/4.0/legalcode"
#         )
#         self.assertEqual(legalcode.language_code, "en")
#
#         tname = TranslatedLicenseName.objects.get(license=license, language_code="it",)
#         self.assertEqual(
...
#         self.assertFalse(license.prohibits_commercial_use)
#         self.assertFalse(license.prohibits_high_income_nation_use)
#         tname = TranslatedLicenseName.objects.get(license=license, language_code="af",)
...
#         self.assertEqual(
#             "http://creativecommons.org/licenses/by-nc-nd/3.0/", license.source.about
#         )
#         self.assertEqual("http://creativecommons.org", license.creator_url)
#         self.assertEqual(
#             "http://creativecommons.org/license/", license.license_class_url
...
#
#         tname = TranslatedLicenseName.objects.get(license=license, language_code="id",)
