...
class Command(BaseCommand):
    """
    Management command that reads all the HTML license files in the specified directories
    and populates the "raw_html" field of the corresponding LegalCode objects.
    ...
    def handle(self, *args, **options):
        # License HTML files are in https://github.com/creativecommons/creativecommons.org/tree/master/docroot/legalcode
        # Let's just assume we've downloaded them somewhere, and pass the input directory.
        # PER
        # https://creativecommons.slack.com/archives/C014SUAT8Q2/p1594919397011700?thread_ts=1594817395.003200&cid=C014SUAT8Q2
        ...
        for html_filename in html_filenames:
            ...
            if data["version"] == "1.0.br":
                # This is a bad license file. There's another one for this license/jurisdiction,
                # so we can just ignore this one.
                continue
            ...
            try:
                ...
                legal_code = LegalCode.objects.create(
                    url=url,
                    license=license,
                    language_code=data["language_code"] or DEFAULT_LANGUAGE_CODE,
                )
