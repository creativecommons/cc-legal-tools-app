...
EMAIL_SUBJECT_PREFIX = os.getenv(
    "EMAIL_SUBJECT_PREFIX", "[CC-Legal-Tools-App %s] " % ENVIRONMENT.title()
)
...
# BROKER_URL = (
#     "amqp://cc_legal_tools_%(ENVIRONMENT)s:%(BROKER_PASSWORD)s@%(BROKER_HOST)s/"
#     "cc_legal_tools_%(ENVIRONMENT)s"
#     % os.environ
# )
