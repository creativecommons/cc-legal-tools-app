...
#
# from licenses.management.commands.transstats import DEFAULT_CSV_FILE
#
#
...
# TEMPLATE_LOADER = jinja2.PackageLoader('deeds', 'templates')
...
#
#
# def XXrender_to_response(request, locale, template_path, context):
#     """
